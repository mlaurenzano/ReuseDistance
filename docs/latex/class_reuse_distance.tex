...
\subsubsection[{GetStats}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ReuseStats} $\ast$ ReuseDistance::GetStats (uint64\_\-t {\em id})\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\index{ReuseDistance@{ReuseDistance}!Process@{Process}}
\index{Process@{Process}!ReuseDistance@{ReuseDistance}}
\subsubsection[{Process}]{\setlength{\rightskip}{0pt plus 5cm}void ReuseDistance::Process ({\bf ReuseEntry} \& {\em addr})\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
